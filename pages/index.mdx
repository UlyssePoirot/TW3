...
- **[MongoDB](/mongoDB)** : Base de données NoSQL adaptée aux besoins des applications modernes. Ce module vous introduira aux concepts de stockage et de gestion des données dans un environnement non relationnel.
...
- **[React](/react)** : Framework JavaScript populaire pour le développement d'interfaces utilisateur dynamiques. Vous explorerez les concepts de composants, d'état, et de gestion d'événements avec React.
